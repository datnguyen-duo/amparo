...
<div class="home_wrap" data-barba="container"  data-barba-namespace="template">
  ...
  <div class="hero_wrap">
    ...
    <div class="hero_buttons">
      <a class="single_button" href="https://calendly.com/hello-amparoart" target="_blank" rel="noopener noreferrer"><span>Let's Talk</span></a>
  ...
  <div class="first_section">
    <div class="first_section_content">
      <div class="headline_wrap">
        ...
        <h2 class="letter_wrap fadein_wrap">Amparo represents fine artists, showcasing a variety of artwork in customizable, virtually staged environments.</h2>
      </div>
        ...
        <div class="container">
          ...
          <div class="image_holder_wrap">
            <div class="image_holder one">
              <img src="<?php echo get_template_directory_uri(); ?>/images/Home Art.jpg" class="bg one">
            </div>
            <div class="image_holder two">
              <img src="<?php echo get_template_directory_uri(); ?>/images/More Home Art.jpg" class="bg two">
            </div>
          ...
          <div class="single_box">
            <div class="box_content fadein_wrap">
              <div class="headline_holder">
                ...
                <h2 class="letter_wrap fadein_wrap">From Web to Wall</h2>
              </div>
