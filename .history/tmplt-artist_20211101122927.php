...
<div class="home_wrap" data-barba="container" data-barba-namespace="template">
  ...
  <div class="hero_wrap">
    ...
    <?php if($hero_link): ?>
      <div class="hero_buttons">
        <a class="single_button" href="https://calendly.com/hello-amparoart" target="<?php echo $hero_link['target'] ?>" rel="noopener noreferrer"><span><?php echo $hero_link['title'] ?></span></a>
  ...
  <div class="first_section">
    <div class="first_section_content">
      ...
      <p class="fadein_wrap fade_up">We work to provide fine artists a platform to enhance their virtual presence, increase exposure and sales while receiving a competitive commission.</p>
    </div>
  </div>
