...
<div class="home_wrap">
  ...
  <header>
    <div class="logo_holder">
    <img src="<?php echo get_template_directory_uri(); ?>/images/white_logo.svg" class="dark">
  ...
  <div class="hero_wrap">
    <div class="image_holder">
      <img src="{{ 'hero__private-collector.png' | asset_url }}" />
      <img src="{{ 'hero__artists.png' | asset_url }}" />
      <img src="{{ 'hero__business.png' | asset_url }}" />
    ...
    <div class="hero_content">
      <div class="small_headline">
        <img src="{{ 'square_shape.svg' | asset_url }}" />
        <p>For Artists</p>
      </div>
  ...
  <div class="first_section">
    <div class="first_section_content">
      <div class="headline_wrap">
        <img src="{{ 'four_squares.svg' | asset_url }}" />
  ...
  <div class="second_section">
    <div class="second_section_content">
      <div class="left">
        <div class="container">
          <img src="{{ 'shape.svg' | asset_url }}" class="shape" />
          <div class="image_holder_wrap">
            <div class="image_holder one">
              <img src="{{ 'bg-1.png' | asset_url }}" class="bg one" />
            </div>
            <div class="image_holder two">
              <img src="{{ 'bg-2.png' | asset_url }}" class="bg two" />
            </div>
            <div class="image_holder three">
              <img src="{{ 'bg-3.png' | asset_url }}" class="bg three" />
            </div>
          </div>
        </div>
          ...
          <div class="single_box">
            <div class="box_content fadein_wrap">
              <div class="headline_holder">
                <img src="{{ 'list_icon.svg' | asset_url }}" />
    ...
    <div class="third_section_content_wrap">
      <div class="third_section_content">
        ...
        <div class="flower_wrap fadein_wrap">
          <img src="{{ 'flowers.png' | asset_url }}" class="flower" />
        </div>
    ...
    <div class="featured_artist_content">
      <div class="single_artist_wrap">
        <div class="single_artist">
          <img src="{{ 'artist_shape.svg' | asset_url }}" class="artist_shape" />
      ...
      <div class="left">
        <div class="left_content">
          ...
          <div class="sign fadein_wrap fade_up">
            <img src="{{ 'dark_square.svg' | asset_url }}" />
            <img src="{{ 'arrow_right.svg' | asset_url }}" />
          </div>
