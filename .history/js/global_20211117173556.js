    ...
    function AddReadMore() {
      ...
      $(".addReadMore").each(function() {
          ...
          if (allstr.length > carLmt) {
              ...
              var strtoadd = firstSet.replace('...',''); + "<span class='SecSec'>" + secdHalf + "</span><span class='readMore'  title='Click to Show More'>" + readMoreTxt + "</span><span class='readLess' title='Click to Show Less'>" + readLessTxt + "</span>";
              $(this).html(strtoadd);
          }
