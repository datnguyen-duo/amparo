...
$section_4_form_id = get_field('section_4_form_id');

$show_fixed_popup = get_field('show_fixed_popup');
$fixed_popup_headline = get_field('fixed_popup_headline');
$fixed_popup_links = get_field('fixed_popup_links');
    ...
    <div class="second_section_content">
      <div class="left">
        <?php if($section_2_list): ?>
          <div class="container">
            <img src="<?php echo get_template_directory_uri(); ?>/images/shape.svg" class="shape_image">
            <svg class="shape" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1163.858" height="1053.07" viewBox="0 0 1163.858 1053.07"><defs><style>.a{fill:#eb7042;}.b{fill:none;stroke:#4b58aa;stroke-width:1px;}.c{clip-path:url(#a);}</style><clipPath id="a"><rect class="a" width="580.929" height="920" rx="290.465" transform="translate(580.929 131.07)"/></clipPath></defs><g transform="translate(1 1)"><line class="b" y2="1050.867" transform="translate(580.929 0.203)"/><rect class="b" width="580.929" height="920" rx="290.465" transform="translate(580.929 131.07)"/><rect class="b" width="580.929" height="920" rx="290.465"/></g></svg>
      ...
      <div class="third_section_content">
        ...
        <div class="bottom_bar">
          <div class="bottom_bar_content">
            ...
            <a class="btn take_quiz" data-text="Take the quiz"> Take the quiz </a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="single_artist_wrap">
            <div class="single_artist"> 
                ...
                <div class="artist_image_wrap">
                  <div class="artist_image">
                    ...
                    <?php if($singleArtist['artist_image']): ?>
                      <img src="<?php echo $singleArtist['artist_image']['url']; ?>" class="artist">
                    <?php else: ?>
              ...
              <div class="artist_info">
                ...
                <p class="test addReadMore showlesscontent">
      ...
      <div class="right">
        ...
        <div class="right_content">
          <div class="form_holder">
            <?php echo do_shortcode('[contact-form-7 id="<?php echo $section_4_form_id; ?>" title="Contact Form"]')?>
          </div>
        </div>
      </div>
    </div>
